...
public class CodeProfiler {
    ...
    public static final String ASPECT_Global = "global";
    ...
    public static double getPercent(String titel) {
    	if(aspectsLength.get(ASPECT_Global) ==null)
    			return -1;
    	
    	double global = aspectsLength.get(ASPECT_Global);
    	double percent = 100 / global * aspectsLength.get(titel);
